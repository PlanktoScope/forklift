...
- (Breaking change; cli) Log messages are now printed to stderr instead of stdout; stdout is only reserved for values meant to be piped or captured in a subshell.
